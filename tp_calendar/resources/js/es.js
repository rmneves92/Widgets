!function(a) {
	"function" == typeof define && define.amd ? define([ "jquery", "moment" ],
		...
		(function(a, b) {
			var c = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic."
					.split("_"), d = "ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic"
					.split("_");
					(b.defineLocale || b.lang)
							.call(
									b,
									"es",
									{
