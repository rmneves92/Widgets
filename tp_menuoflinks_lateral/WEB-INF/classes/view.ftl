	...
	<div class="tp-menu-navbar navbar-default" role="navigation" style="display: block">
	    <div class="container divMenuLinks">	 
	        ...
	        <div class="collapse navbar-collapse">	   
	        	<ul class="nav navbar-nav navbar-left firstFontStyle"></ul>
	        	<ul class="nav navbar-nav navbar-center firstFontStyle"></ul>
	        	<ul class="nav navbar-nav navbar-right firstFontStyle"></ul>
			</div><!--/.nav-collapse -->
	    </div>
	</div>
